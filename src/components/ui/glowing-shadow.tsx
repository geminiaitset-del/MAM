    ...
    <>
      <style>{`
        ...
        .glow-content:before {
          ...
          z-index: -1;
          background: hsl(0deg 0% 10%) radial-gradient(30% 30% at calc(var(--bg-x) * 1%) calc(var(--bg-y) * 1%),
            hsl(calc(var(--hue) * var(--hue-speed) * 1deg) 100% 70%) calc(0% * var(--bg-size)),
            hsl(calc(var(--hue) * var(--hue-speed) * 1deg) 100% 55%) calc(40% * var(--bg-size)),
            transparent 100%);
        ...
        .glow-container:hover .glow-content {
          ...
          box-shadow: 0 0 calc(var(--white-shadow) * 1vw) calc(var(--white-shadow) * 0.15vw) rgb(0 255 148 / 25%);
