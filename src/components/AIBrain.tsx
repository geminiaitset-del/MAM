        ...
        <div className="lg:col-span-6 flex justify-center">
          <div className="w-full max-w-[500px] flex flex-col gap-4">
            <div className="flex justify-between items-center mb-2 px-2">
              <span className="text-[10px] font-mono text-white/30 tracking-widest uppercase">INFRASTRUCTURE STACK // LAYERS</span>
              <span className="text-[10px] font-mono text-white/30 tracking-widest uppercase">SYSTEM STATE // OK</span>
            </div>
                ...
                >
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <p className={`text-[11px] text-[#A1A8B8] mt-1.5 leading-relaxed overflow-hidden transition-all duration-300 ${
